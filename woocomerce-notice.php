...
class Woocommerce_Notice{
    ...
    function __construct(){
        ...
        $this->api = new WoocommerceApi("https://vals-natural-journey.de", $this->datastore->GetConsumerKey(), $this->datastore->GetConsumerSecret());
        $this->api->InitAjax();
...
{
    private $website;
    private $consumerkey; //ck_e3b74a274632a79a51f2e92809c392a30b7e8266
    private  $consumerSecret; //cs_fa92ad1ba2a3742e8ee3fa72161e650e871ee069
         
    function __construct($website,$consumerkey,$consumerSecret){
    ...
    {              
        $request = "$this->website/wp-json/wc/v2/products/$id?$this->GetUrlSecurityString()";
        return  HttpGet($request);
    }

    function GetAllOrders()
    {          
        $request = "$this->website/wp-json/wc/v1/orders?$this->GetUrlSecurityString()";
        return  HttpGet($request);
    }

    function GetAllReviews($id)
    {          
        $request = "$this->website/wp-json/wc/v2/products/$id/reviews?$this->GetUrlSecurityString()";
        return  HttpGet($request);
    }
    ...
    function GetLanguage($code)
    {
        ...
        return $countries[$_POST['code']];
    }
    
    function AddAjaxFunction($code, $funcName)
    {
        add_action( 'wp_ajax_nopriv_' . $code, $funcName );
        add_action( 'wp_ajax_' . $code, $funcName );
    }
    
    public function InitAjax()
    {
        AddAjaxFunction("get_language","GetLanguageAjax");
        AddAjaxFunction("get_product","GetProductAjax");
        AddAjaxFunction("get_all_orders","GetAllOrdersAjax");
        AddAjaxFunction("get_all_reviews","GetAllReviewsAjax");
    }

    function GetLanguageAjax()
    {
        echo GetLanguage($_POST['code']);
        wp_die();
    }

    function GetProductAjax()
    {
        echo GetProduct(intval($_POST['id']));
        wp_die();
    }
    ...
    function GetAllReviewsAjax()
    {
        echo GetAllReviews($_POST['id']);
        wp_die();
    }
}
